README for functional alignment toolbox V0.2 PRELIMINARY CODE - NO RELEASE  / July 2012

Code authors: 
Georg Langs, CIR Lab, Medical University of Vienna; CSAIL Massachusetts Institute of Technology
Andrew Sweet CSAIL Massachusetts Institute of Technology

This is preliminary code, not suited for distribution. Please don't distribute. 

If you use the code, please cite the corresponding paper:


@article{Langs:2011aa,
