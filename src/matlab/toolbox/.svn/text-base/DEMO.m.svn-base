% DEMO script for functional geometry map building and atlas construction
%
...
[maps{1}] = atlas_build_functional_map(data1)
% add spatial / anatomy coords:
maps{1}.Coords = data1.Coords;

% build map for subject 2:
[maps{2}] = atlas_build_functional_map(data2)
% add spatial / anatomy coords:
...
[atlas, mymaps_aligned] = atlas_groupwise_registration_orthonormal(maps, verbose)
